...
| Input replay and projection | The actual source-built `$1609` scanner is CPU-replayed for all 16 keyboard masks and `$1287` for 72 joystick X/Y/fire edge combinations; four fire-latch transitions are also checked against the preserved control/movement contract | Port-contract |
