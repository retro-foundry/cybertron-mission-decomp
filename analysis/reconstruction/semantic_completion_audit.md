...
1. Add actual-code replay coverage for player collision outcomes and integrate
   `$205D` enemy movement validation with the real movement, renderer-collision,
   bounds, and restoration leaves. Scheduler, decision primitives, and policy
   branch order are covered.
