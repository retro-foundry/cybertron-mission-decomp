...
| Input replay and projection | The actual source-built `$1609` scanner is CPU-replayed for all 16 keyboard masks; six joystick threshold boundaries and four fire-latch transitions are also checked against the preserved control/movement contract | Port-contract |
